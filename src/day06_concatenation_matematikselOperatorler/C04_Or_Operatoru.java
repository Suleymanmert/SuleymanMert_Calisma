...
public class C04_Or_Operatoru {
    ...
    public static void main(String[] args) {
        ...
        /* Or poaratoru iyimserdir
        yani tek bir true bile yeterli olur
        or oparatorunde tum mantiksal ifadeler false ise sonuc false
        degilse sonuc true dur



        Or oparatoru matematikteki toplama islemine benzer
        toplanan sayırlarda bir tane bile 0 olmayan varsa,sonuc sifir olmaz
